...
def fetch_realtime_prices_batch(symbols):
    ...
    for s in symbols:
        # Simple prefix logic
        # BUG: If s is "600000.SH", s.startswith('6') is True, code becomes "sh600000.SH"
            ...
            if resp.status_code == 200:
                ...
                for line in lines:
                    if '="' in line:
                        ...
                        # If request was sh600000.SH, response might be different or empty
                        print(f"DEBUG: Response line LHS: {lhs}, Code: {code_with_prefix}, RHS len: {len(rhs)}")
